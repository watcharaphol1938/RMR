...
export default {
  ...
  data() {
    return {
      layout: [
        { x: 0, y: 0, w: 3, h: 3, i: "Coil Up", alert: true },
        { x: 0, y: 0, w: 1.5, h: 3, i: "SRKH", alert: false },
        { x: 1.5, y: 0, w: 1.5, h: 3, i: "Tube Intercooler" },
        ...
        // { x: 1.2, y: 0, w: 5.6, h: 1.4, i: "W/H DNKH" },
        // { x: 6.8, y: 0, w: 8, h: 1.4, i: "W/H DNKH2" },
        // { x: 0.2, y: 0, w: 1, h: 1.4, i: "W/H SRKH" },
        // { x: 0, y: 0, w: 0.2, h: 1.4, i: "Battery Charges" },
      ],
      draggable: true,
      resizable: true,
      bounded: true,
